...
func (c *authV1Client) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedAuthV1Server) Register(context.Context, *RegisterRequest) (*emptypb.Empty, error) {
