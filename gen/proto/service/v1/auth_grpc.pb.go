...
const (
	AuthV1_SignUp_FullMethodName  = "/proto.service.v1.AuthV1/SignUp"
	AuthV1_SignIn_FullMethodName  = "/proto.service.v1.AuthV1/SignIn"
	AuthV1_Check_FullMethodName   = "/proto.service.v1.AuthV1/Check"
	AuthV1_Refresh_FullMethodName = "/proto.service.v1.AuthV1/Refresh"
)
...
type AuthV1Client interface {
	SignUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*v1.User, error)
...
func (c *authV1Client) SignUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*v1.User, error) {
...
type AuthV1Server interface {
	SignUp(context.Context, *SignUpRequest) (*v1.User, error)
...
func (UnimplementedAuthV1Server) SignUp(context.Context, *SignUpRequest) (*v1.User, error) {
...
var AuthV1_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.service.v1.AuthV1",
	...
	Metadata: "proto/service/v1/auth.proto",
}
